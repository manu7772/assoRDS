...
// Entité
use AcmeGroup\LaboBundle\Entity\membre;

class membres extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface {
	private $ord			= 8;			// Ordre de chargement fixtures
	private $entity			= "membre";	// nom de l'entité
	private $container;
	private $manager;
