...
// Entité
use AcmeGroup\LaboBundle\Entity\typeMembre;

class typeMembres extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface {
	private $ord			= 2;			// Ordre de chargement fixtures
	private $entity			= "typeMembre";		// nom de l'entité
	private $container;
	private $manager;
